...
class UnitOperation : public QGraphicsObject, public ItemWithId {
  Q_OBJECT
public:
  enum { Type = QGraphicsItem::UserType + 3 };

  explicit UnitOperation( int minInputSz, int maxInputSz, int minOutputSz, int maxOutputSz,
